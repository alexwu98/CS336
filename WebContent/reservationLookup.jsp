...
<%try {
		...
		String verifyStop= "SELECT r.*, s.departure_date FROM Reservations r, Schedules s WHERE r.schedule_id=s.schedule_id AND s.transit_name=? AND CAST(s.departure_date AS DATE)=?";
